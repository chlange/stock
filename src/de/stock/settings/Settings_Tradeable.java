...
/**
 * Provides settings for the {@link de.stock.tradable.Tradable tradable}
 * system
 * 
...
public final class Settings_Tradeable {
     ...
     * Tradable.updateValue()} to check whether sign is positive or negative<br>
     * <br>
    ...
    /**
     * If a tradable value falls to or below zero (through
     * {@link de.stock.tradable.Tradable#updateValue() updateValue()}) the
     * value gets a
